...
(function(n, t) {
    ...
    i.connect = function(n, r) {
        ...
        u.host = u.host || (t.document ? t.document.domain : t.location.hostname),
...
(function(n, t) {
    var i = n.util = {}, f = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, u = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"], r;
    ...
    i.query = function(n, t) {
        ...
        for (r in u)
            u.hasOwnProperty(r) && f.push(r + "=" + u[r]);
    ...
    i.merge = function(n, t, r, u) {
        ...
        for (f in t)
            t.hasOwnProperty(f) && i.indexOf(e, f) < 0 && (typeof n[f] == "object" && o ? i.merge(n[f], t[f], o - 1, e) : (n[f] = t[f],
            e.push(t[f])));
        return n
    }
    ,
    ...
    i.intersect = function(n, t) {
        for (var f = [], o = n.length > t.length ? n : t, u = n.length > t.length ? t : n, r = 0, e = u.length; r < e; r++)
    ...
    i.prototype.removeListener = function(n, i) {
        ...
        if (this.$events && this.$events[n]) {
            ...
            if (t.util.isArray(r)) {
                ...
                (r === i || r.listener && r.listener === i) && delete this.$events[n]
        }
        return this
    }
    ,
...
(function(n, t) {
    ...
    function s(n) {
        ...
        h.test(n) ? '"' + n.replace(h, function(n) {
            var t = l[n];
    ...
    function e(n, t) {
        ...
        case "object":
            ...
            if (r && typeof r == "object")
                for (v = r.length,
                h = 0; h < v; h += 1)
                    typeof r[h] == "string" && (l = r[h],
                    c = e(l, u),
                    c && o.push(s(l) + (i ? ": " : ":") + c));
            else
                for (l in u)
                    Object.prototype.hasOwnProperty.call(u, l) && (c = e(l, u),
                    c && o.push(s(l) + (i ? ": " : ":") + c));
            return c = o.length === 0 ? "{}" : i ? "{\n" + i + o.join(",\n" + i) + "\n" + y + "}" : "{" + o.join(",") + "}",
            i = y,
            c
    ...
    o = n.JSON = {};
    var c = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, h = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, i, f, l = {
        "\b": "\\b",
        "\t": "\\t",
        "\n": "\\n",
        "\f": "\\f",
...
(function(n, t) {
    var i = n.parser = {}, e = i.packets = ["disconnect", "connect", "heartbeat", "message", "json", "event", "ack", "error", "noop"], o = i.reasons = ["transport not supported", "client not handshaken", "unauthorized"], s = i.advice = ["reconnect"], r = t.JSON, u = t.util.indexOf, f;
    ...
    i.decodePayload = function(n) {
        ...
        if (n.charAt(0) == "\ufffd") {
            ...
            t = 1,
            r = ""; t < n.length; t++)
                n.charAt(t) == "\ufffd" ? (u.push(i.decodePacket(n.substr(t + 1).substr(0, r))),
                t += Number(r) + 1,
                r = "") : r += n.charAt(t);
            return u
        }
...
(function(n, t, i) {
    ...
    r.prototype.of = function(n) {
        return this.namespaces[n] || (this.namespaces[n] = new t.SocketNamespace(this,n),
        n !== "" && this.namespaces[n].packet({
            type: "connect"
        })),
        this.namespaces[n]
    }
    ...
    r.prototype.publish = function() {
        ...
        for (n in this.namespaces)
            this.namespaces.hasOwnProperty(n) && (t = this.of(n),
    ...
    r.prototype.handshake = function(n) {
        function s(t) {
            if (t instanceof Error)
                ...
                n.apply(null, t.split(":"))
        }
        var o = this, f = this.options, h = ["http" + (f.secure ? "s" : "") + ":/", f.host + ":" + f.port, f.resource, t.protocol, t.util.query(this.options.query, "t=" + +new Date)].join("/"), e, r, i;
        this.isXDomain() && !t.util.ua.hasCORS ? (e = document.getElementsByTagName("script")[0],
    ...
    r.prototype.connect = function(n) {
        ...
        return this.handshake(function(r, u, f, e) {
            function o(n) {
                ...
                if (!i.transport)
                    return i.publish("connect_failed");
    ...
    r.prototype.setBuffer = function(n) {
        this.doBuffer = n,
        !n && this.connected && this.buffer.length && (this.transport.payload(this.buffer),
        this.buffer = [])
    }
    ,
    ...
    r.prototype.reconnect = function() {
        function i() {
            if (n.connected) {
                for (var i in n.namespaces)
                    n.namespaces.hasOwnProperty(i) && "" !== i && n.namespaces[i].packet({
                        type: "connect"
                    });
        ...
        function t() {
            ...
            else if (n.redoTransports)
                n.publish("reconnect_failed"),
                i();
            else {
...
(function(n, t) {
    ...
    i.prototype.send = function(n, t) {
        ...
        return "function" == typeof t && (i.id = ++this.ackPackets,
        i.ack = !0,
        this.acks[i.id] = t),
        this.packet(i)
    }
    ...
    i.prototype.emit = function(n) {
        ...
        return "function" == typeof r && (i.id = ++this.ackPackets,
        i.ack = "data",
        this.acks[i.id] = r,
    ...
    i.prototype.onPacket = function(n) {
        ...
        case "event":
            ...
            break;
        case "ack":
            this.acks[n.ackId] && (this.acks[n.ackId].apply(this, n.args),
        ...
        case "error":
            if (n.advice)
                ...
                n.reason == "unauthorized" ? this.$emit("connect_failed", n.reason) : this.$emit("error", n.reason)
        }
    }
    ,
...
if ("undefined" != typeof window)
    var swfobject = function() {
            ...
            if (y > 0)
                for (r = 0; r < y; r++) {
                    ...
                    if (n.pv[0] > 0) {
                            ...
                            if (!g(h[r].swfVersion) || n.wk && n.wk < 312)
                                if (h[r].expressInstall && tt()) {
                                    ...
                                    var p = {}
                                      ...
                                      , w = a.length;
                                    for (c = 0; c < w; c++)
                                        a[c].getAttribute("name").toLowerCase() != "movie" && (p[a[c].getAttribute("name")] = a[c].getAttribute("value"));
                                    et(e, p, o, s)
                                } else
                                    ui(t),
                                    s && s(f);
                        ...
                        l(o, !0),
                        s && (v = it(o),
                        v && typeof v.SetVariable != i && (f.success = !0,
                        f.ref = v),
                        s(f))
                }
        }
        ...
        function et(f, e, o, h) {
            ...
            n.ie && n.win && c.readyState != 4 && (a = s("div"),
            o += "SWFObjectNew",
            a.setAttribute("id", o),
        ...
        function ui(t) {
            if (n.ie && n.win && t.readyState != 4) {
                ...
                t.parentNode.replaceChild(ft(t), t)
        }
        function ft(t) {
            var e = s("div"), u, i, o, r;
            if (n.win && n.ie)
        ...
        function rt(t, r, e) {
            ...
            if (w) {
                ...
                if (n.ie && n.win) {
                    y = "";
                    for (o in t)
                        t[o] != Object.prototype[o] && (o.toLowerCase() == "data" ? r.movie = t[o] : o.toLowerCase() == "styleclass" ? y += ' class="' + t[o] + '"' : o.toLowerCase() != "classid" && (y += " " + o + '="' + t[o] + '"'));
                    b = "";
                    for (a in r)
                        r[a] != Object.prototype[a] && (b += '<param name="' + a + '" value="' + r[a] + '" />');
                    ...
                    for (h in t)
                        t[h] != Object.prototype[h] && (h.toLowerCase() == "styleclass" ? c.setAttribute("class", t[h]) : h.toLowerCase() != "classid" && c.setAttribute(h, t[h]));
                    for (l in r)
                        r[l] != Object.prototype[l] && l.toLowerCase() != "movie" && ri(c, l, r[l]);
        ...
        var i = "undefined", f = "object", at = "Shockwave Flash", ti = "ShockwaveFlash.ShockwaveFlash", p = "application/x-shockwave-flash", lt = "SWFObjectExprInst", yt = "onreadystatechange", r = window, t = document, o = navigator, vt = !1, b = [ni], h = [], k = [], a = [], y, d, ut, ct, c = !1, w = !1, e, ot, bt = !0, n = function() {
            var a = typeof t.getElementById != i && typeof t.getElementsByTagName != i && typeof t.createElement != i, s = o.userAgent.toLowerCase(), e = o.platform.toLowerCase(), l = e ? /win/.test(e) : /win/.test(s), y = e ? /mac/.test(e) : /mac/.test(s), v = /webkit/.test(s) ? parseFloat(s.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, h = !1, u = [0, 0, 0], n = null, c;
            if (typeof o.plugins != i && typeof o.plugins[at] == f)
                n = o.plugins[at].description,
                !n || typeof o.mimeTypes != i && o.mimeTypes[p] && !o.mimeTypes[p].enabledPlugin || (vt = !0,
                h = !1,
            ...
            n.ie && n.win && (t.attachEvent(yt, function() {
                t.readyState == "complete" && (t.detachEvent(yt, arguments.callee),
                v())
            }),
            r == top && (function() {
                if (c)
        ...
        return {
            ...
            embedSWF: function(t, r, u, e, o, s, h, c, a, v) {
                ...
                n.w3 && !(n.wk && n.wk < 312) && t && r && u && e && o ? (l(r, !1),
                kt(function() {
                    var n, k, p, b, w, d;
                    u += "",
                    e += "",
            ...
            expressInstallCallback: function() {
                if (w) {
                    var t = u(lt);
                    t && y && (t.parentNode.replaceChild(y, t),
                    d && (l(d, !0),
                    n.ie && n.win && (y.style.display = "block")),
                    ut && ut(ct)),
                    w = !1
                }
            }
...
(function() {
    ...
    WebSocket.prototype.addEventListener = function(n, t) {
        n in this.__events || (this.__events[n] = []),
        this.__events[n].push(t)
    }
    ,
    WebSocket.prototype.removeEventListener = function(n, t) {
        var u, r;
        if (!(n in this.__events))
            return;
        for (u = this.__events[n],
        r = u.length - 1; r >= 0; --r)
            if (u[r] === t) {
                u.splice(r, 1);
                break
    ...
    WebSocket.prototype.__handleEvent = function(n) {
        ...
        if (n.type == "open" || n.type == "error")
            ...
            throw "unknown event type: " + n.type;
    ...
    WebSocket.prototype.__createMessageEvent = function(n, t) {
        if (document.createEvent && window.MessageEvent && !window.opera) {
            ...
            return i.initMessageEvent("message", !1, !1, t, null, null, window, null),
            i
        }
        return {
            type: n,
...
(function(n, t, i) {
    ...
    r.prototype.post = function(n) {
        function f() {
            this.readyState == 4 && (this.onreadystatechange = u,
            t.posting = !1,
...
(function(n, t, i) {
    ...
    r.prototype.open = function() {
        var n = this;
        return t.Transport.XHR.prototype.open.call(n),
        !1
    }
    ,
    r.prototype.get = function() {
        ...
        i.XDomainRequest && this.xhr instanceof XDomainRequest ? (this.xhr.onload = r,
        this.xhr.onerror = t) : this.xhr.onreadystatechange = f,
        this.xhr.send(null)
    }
    ,
    r.prototype.onClose = function() {
...
(function(n, t, i) {
    ...
    r.prototype.post = function(n) {
        ...
        if (!this.form) {
            var i = document.createElement("form"), f = document.createElement("textarea"), s = this.iframeId = "socketio_iframe_" + this.index, u;
    ...
    ,
    r.prototype.get = function() {
        var r = this, n = document.createElement("script"), f = t.util.query(this.socket.options.query, "t=" + +new Date + "&i=" + this.index), i;
